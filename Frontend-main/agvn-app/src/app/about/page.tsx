    ...
    <Layout>
      ...
      <Flex m="4rem" flexDir="column">
        <Flex className="voting-container" justifyContent="center" alignItems="center" flexDir="column" mb="5rem">
          <Heading textAlign="center" mb="1rem">A-GVN System</Heading>
          <Divider width='50%' />
          <Flex alignItems="center" justifyContent="center" mb="1rem" maxW="70%">
            <Text m="2.5rem" w="65%">
            ...
            <Image src="/assets/AGVN_logos/AGVN.png" w="35%" alt="AGVN Logo" />
          </Flex>
        </Flex>
        <Flex className="contribution-container" justifyContent="center" alignItems="center" flexDir="column" mb="5rem">
          <Flex alignItems="center" justifyContent="center" mb="1rem" maxW="70%">
            <Text m="2.5rem" w="65%">
            ...
            <Image src="/assets/voteInitiatives.png" w="35%" alt="Vote Initiatives" />
          </Flex>
